 ...
 * ```
 */
const processExceptionHandlersPlugin = async (fastify, options) => {
    ...
    if (config.enableGracefulShutdown) {
        const closeServerListeners = closeWithGrace({ delay: config.shutdownTimeout || 10000 }, async function (context) {
