...
import { defaultConfig, devConfig, prodConfig, minimalConfig } from './config.js';
describe('Process Exception Configuration', () => {
    ...
    describe('Development Configuration', () => {
        ...
        it('should have shorter timeout for faster iteration', () => {
            ...
            expect(devConfig.shutdownTimeout).toBeLessThan(defaultConfig.shutdownTimeout);
        });
        it('should have all feature flags enabled', () => {
    ...
    describe('Production Configuration', () => {
        ...
        it('should have longer timeout for proper cleanup', () => {
            ...
            expect(prodConfig.shutdownTimeout).toBeGreaterThan(defaultConfig.shutdownTimeout);
            expect(prodConfig.shutdownTimeout).toBeGreaterThan(devConfig.shutdownTimeout);
        });
    ...
    describe('Configuration Comparison', () => {
        it('should have increasing timeouts from dev to prod', () => {
            expect(devConfig.shutdownTimeout).toBeLessThan(defaultConfig.shutdownTimeout);
            expect(defaultConfig.shutdownTimeout).toBeLessThan(prodConfig.shutdownTimeout);
        });
...
//# sourceMappingURL=config.spec.vite.js.map