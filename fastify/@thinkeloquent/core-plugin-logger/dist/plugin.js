...
const pluginLoggerPlugin = async (fastify, options) => {
    ...
    fastify.addHook('onReady', async function () {
        ...
        try {
            ...
            const hookDuration = Date.now() - hookStartTime;
            fastify.log.error({ error, stack: error instanceof Error ? error.stack : undefined, hook: 'onReady', plugin: 'core-plugin-logger', duration: hookDuration }, 'Plugin logger onReady hook failed');
